...
Tous les paramètres sont significativement différents de 0 au seuil $\alpha$ de 5%. La déviance des résidus est de 1,3, cette valeur est assez proche de 1, il n'y a pas de surdispersion et il ne faut donc pas réajuster le paramètre de dispersion.
