...
Le graphique montre que la relation entre la condition corporelle (masse/longueur totale) et la longueur totale diffère légèrement entre mâles et femelles de *Varanus salvator*. Les mâles présentent en moyenne une condition corporelle un peu plus élevée pour une même longueur, ce qui reflète leur morphologie plus robuste. Bien que la variabilité soit importante, cette tendance indique que l’indice de condition corporelle peut potentiellement contribuer au sexage des individus.
...
-femelles ont des valeurs d'au moins 1 centimètre plus basses que les mâles dans les 2 variables
