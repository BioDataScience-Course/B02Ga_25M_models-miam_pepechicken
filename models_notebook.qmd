...
La largeur et longueur du crâne des Vanarus salvator diffèrent entre les individus mâles et femelles : les mâles semblent avoir une largeur de crâne globalement centrée autour d’une valeur plus élevée que les femelles, qui présentent des valeurs plus basses d'au moins 1 centimètre dans les 2 variables.

Ainsi les femelles ont en moyenne un crâne légèrement plus petit que les mâles, même si la variation reste importante dans les deux sexes.
...
Ce modèle est trop complexe car on voit que bêta 2 et bêta 3 ne sont pas significativement différents de O au seuil alpha de 5%. Nous allons donc tenter de le simplifier.
...
Tous les paramètres sont significativement différents de 0 au seuil alpha de 5%. Le R\^2 est de 0,62 ce qui montre que le modèle est relativement bon. De plus, la valeur de p est très inférieure à 0,05 ce qui signifie que le modèle-le est significatif.
...
observe une relation linéaire, plus la largeur du crâne augmente, plus la longueur du crâne augmente. Les points sont relativement proches de la droite, la largeur du crâne explique bien la longueur.

alpha de 2.575 et pente beta de 0.449

beta significatif donc prouve une relation, le R\^2 est de environ 0.756 = bon modèle
