...
On observe une relation linéaire, plus la largeur du crâne augmente, plus la longueur du crâne augmente. Les points sont relativement proches de la droite, la largeur du crâne explique bien la longueur.

alpha de 2.575 et pente beta de 0.449

le R\^2 est de environ 0.756 = bon modèle

Distribution des résidus linéaire, les résidus semblent suivre une distribution Normale, la variance des résidus indique une homoscédasticité, pas de valeurs extrèmes
