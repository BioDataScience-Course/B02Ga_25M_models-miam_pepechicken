...
Tous les paramètres sont significativement différents de 0 au seuil $\alpha$ de 5%. Le $R^2$ est de 0,76 ce qui montre que le modèle est relativement bon. De plus, la valeur de p est très inférieure à 0,05 ce qui signifie que le modèle est significatif.
...
Tous les paramètres sont significativement différents de 0 au seuil $\alpha$ de 5%.
