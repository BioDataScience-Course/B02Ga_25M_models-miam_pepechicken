...
```{rregressionlineaire1AlexiaetCamille}

```

```{rregressionlineaire1JeanneetLou}
...
```{rregressionlineaire2AlexiaetCamille}

```

```{rregressionlineaire2JeanneetLou}
...
```{rmodelelineaire1AlexiaetCamille}
...
\`\`\`{rModelelineairegeneraliseet/oumixte1AlexiaetCamille}
...
```{rModelelineairegeneraliseet/oumixte1JeanneetLou}
```
